...
public class MetadataCacheTests {
    ...
    public void testMetadataCacheInitialized() throws Exception {
        ...
        partitionMetadatas.$plus$eq(
                new PartitionMetadata(0, asScalaOption(new BrokerEndPoint(0, "host0", 1000)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        partitionMetadatas.$plus$eq(
                new PartitionMetadata(1, asScalaOption(new BrokerEndPoint(0, "host1", 1001)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        topicMetadatas.add(new TopicMetadata(
                new kafka.api.TopicMetadata(EXISTING_TOPIC, partitionMetadatas.toSeq(), ErrorMapping.NoError())));
    ...
    public void testMetadataCacheMergedWithOverride() throws Exception {
        ...
        topic2partitionMetadatas.$plus$eq(
                new PartitionMetadata(0, asScalaOption(new BrokerEndPoint(0, "host1", 1002)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        topic2partitionMetadatas.$plus$eq(
                new PartitionMetadata(1, asScalaOption(new BrokerEndPoint(0, "host2", 1003)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        topic2partitionMetadatas.$plus$eq(
                new PartitionMetadata(2, asScalaOption(new BrokerEndPoint(0, "host3", 1004)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        topic2Metadatas.add(new TopicMetadata(
                new kafka.api.TopicMetadata(EXISTING_TOPIC_2, topic2partitionMetadatas.toSeq(),
                        ErrorMapping.NoError())));
        ...
        assertThat(metadataCacheWithTopic2.getPartitions(EXISTING_TOPIC_2),
                hasItem(new Partition(EXISTING_TOPIC_2, 0)));
        assertThat(metadataCacheWithTopic2.getPartitions(EXISTING_TOPIC_2),
                hasItem(new Partition(EXISTING_TOPIC_2, 1)));
        assertThat(metadataCacheWithTopic2.getPartitions(EXISTING_TOPIC_2),
                hasItem(new Partition(EXISTING_TOPIC_2, 2)));
        ...
        overridingPartitionsMetadatas.$plus$eq(
                new PartitionMetadata(0, asScalaOption(new BrokerEndPoint(0, "host10", 2000)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        overridingPartitionsMetadatas.$plus$eq(
                new PartitionMetadata(1, asScalaOption(new BrokerEndPoint(0, "host11", 2001)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        overridingPartitionsMetadatas.$plus$eq(
                new PartitionMetadata(2, asScalaOption(new BrokerEndPoint(0, "host12", 2002)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        overridingPartitionsMetadatas.$plus$eq(
                new PartitionMetadata(3, asScalaOption(new BrokerEndPoint(0, "host13", 2003)), emptySeq(), emptySeq(),
                        ErrorMapping.NoError()));
        overridingTopicMetadatas.add(new TopicMetadata(
                new kafka.api.TopicMetadata(EXISTING_TOPIC, overridingPartitionsMetadatas.toSeq(),
                        ErrorMapping.NoError())));
        ...
        assertThat(metadataCacheOverridden.getPartitions(EXISTING_TOPIC_2),
                hasItem(new Partition(EXISTING_TOPIC_2, 0)));
        assertThat(metadataCacheOverridden.getPartitions(EXISTING_TOPIC_2),
                hasItem(new Partition(EXISTING_TOPIC_2, 1)));
        assertThat(metadataCacheOverridden.getPartitions(EXISTING_TOPIC_2),
    ...
    public Seq<BrokerEndPoint> emptySeq() {
        return HashSet$.MODULE$.<BrokerEndPoint>empty().toSeq();
    }
